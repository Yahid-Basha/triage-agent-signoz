...
|---|--------|--------------|-------------|-------|-----------|-------|
| 1 | done | Terminal: cast output all green | TODO | 1 | Setup, honest friction | 12/12 containers; one expected "Exited" (init script, not a failure) |
| 2 | done | Empty dashboard "no data yet" | TODO | 1 | Setup, honest friction | Admin account created first, per orgId gotcha |
| 3 | done | Fidelity table (live vs logged vs drift) | verified_fidelity.txt | 2 | "Same code as April, bit for bit" | Max drift 2.44e-08, ~40x under the ~1e-6 bar |
| 4 | done | First span tree + attribute panel | TODO (waterfall) + TODO (reward.parsimony panel) | 3 | How rewards became spans | 57 spans = 1 root + 8x7; batch.size=8; float32-drift smoking gun in reward.logged_score |
